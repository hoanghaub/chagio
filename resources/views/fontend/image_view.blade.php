...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{url('')}}/public/template/css/image.css">
  </head>
  <body>
     ...
     <section class="section bg-light py-5  bottom-slant-gray">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="container">
            <div class="row">
            @foreach($images_cs1_view as $i1v)
              <div class="col-md-3" style="padding:15px">
                
                <img src="{{url('public/image')}}/{{$i1v['img']}}" alt="" width="250px" height="150px">
              </div>
            @endforeach
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
            @foreach($images_cs2_view as $i2v)
               <div class="col-md-3" style="padding:15px">
                  <img src="{{url('public/image')}}/{{$i2v['img']}}" alt="" width="250px" height="150px"> 
               </div>
            @endforeach
            </div>
          </div>
          ...
          <div class="container">
             <div class="row">
              @foreach($images_cs3_view as $i3v)
                <div class="col-md-3" style="padding:15px">
                    <img src="{{url('public/image')}}/{{$i3v['img']}}" alt="" width="250px" height="150px">
                </div>
              @endforeach
             </div>
          </div>
          ...
          <div class="container">
             <div class="row">
              @foreach($images_cs4_view as $i4v)
                <div class="col-md-3" style="padding:15px">
                    <img src="{{url('public/image')}}/{{$i4v['img']}}" alt="" width="250px" height="150px">
                </div>
              @endforeach
             </div>
          </div>
          ...
          <div class="container">
             <div class="row">
              @foreach($images_cs5_view as $i5v)
                <div class="col-md-3" style="padding:15px">
                    <img src="{{url('public/image')}}/{{$i5v['img']}}" alt="" width="250px" height="150px">
                </div>
              @endforeach
             </div>
          </div>
          ...
          <div class="container">
             <div class="row">
              @foreach($images_customer_view as $icv)
               <div class="col-md-3" style="padding:15px">
                   <img src="{{url('public/image')}}/{{$icv['img']}}" alt="" width="250px" height="150px">
               </div>
              @endforeach
             </div>
          </div>
