        ...
        <div class="row">
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="100">
            ...
            @foreach($news_view as $nv)
              <a class="bg-image d-block" href="#" style="background-image: url('{{url('')}}/public/template/img/news1.jpg');"></a>
              <div class="text">
                <h3><a href="#">{{$nv['title']}}</a></h3>
                <p class="sched-time">
                  <span> {{$nv['day']}}</span> <br>
                </p>
                <p>{{$nv['content']}}</p>
                <p><a href="{{route('news_detail_view',['id'=>$nv['id']])}}" class="btn btn-primary btn-sm" id="{{$nv['id']}}">Xem Thêm</a></p>
              </div>
            @endforeach
            </div>
            <br>
          ...
          <div class="col-md-4 text-justify" data-aos="fade-up" data-aos-delay="200">
              <h2>Bài Viết Mới Nhất</h2>
            @foreach($article_view as $av)
              <p><a href="{{route('article_detail_view',['id'=>$nv['id']])}}" id="{{$av['id']}}">{{$av['name']}}</a></p>
            @endforeach
          </div>
        </div>
      </div>
