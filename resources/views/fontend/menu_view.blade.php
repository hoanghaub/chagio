      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center" data-aos="fade">
            <div class="col-md-7 text-center heading-wrap">
              <h2 data-aos="fade-up">Thực Đơn Tại Vua Chả Giò</h2>
              <p data-aos="fade-up" data-aos-delay="100">Những món ăn hấp dẫn mang lại cảm giác trở về thời xưa của hà thành</p>
            </div>
          </div>
        
        <div class="row align-items-center">
        @foreach($menu_view as $mv)
          <div class="col-lg-4">
            <img src="{{url('public/image')}}/{{$mv['img']}}" alt="Image" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="200">
          </div>
        @endforeach  
        </div>
      </div>
