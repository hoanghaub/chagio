    ...
    <section class="section bg-light py-5  bottom-slant-gray">
      <div class="container">
        <div class="row align-items-center">
          @foreach($introduction_view as $iv)
            <img src="{{url('public/image')}}/{{$iv['img']}}" alt="Image" class="img-fluid">
            <div class="text-left heading-wrap">
              <h2 data-aos="fade-up">{{$iv['title']}}</h2>
            </div>
          ...
          <div class="introduction-img" style="padding: 15px;">
            <img src="{{url('public/image')}}/{{$i1v['img']}}" alt="">
          </div>
          @endforeach
        </div>
      </div>
